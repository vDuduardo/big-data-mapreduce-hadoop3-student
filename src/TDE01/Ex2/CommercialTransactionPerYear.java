...
public class CommercialTransactionPerYear {
    ...
    public static void main(String[] args) throws IOException, ClassNotFoundException, InterruptedException {
        ...
        j.setMapperClass(CommercialTransactionPerYear.Map.class);
        j.setReducerClass(CommercialTransactionPerYear.Reduce.class);
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        public void map(LongWritable key, Text value, Context context)
            ...
            /**
             * Será emitido uma chave do tipo Text, agrupando todos os anos
    ...
    public static class Reduce extends Reducer<Text, IntWritable, Text, IntWritable> {
        ...
        public void reduce(Text key, Iterable<IntWritable> values, Context context)
             ...
             * Foi criado uma variável para guardar o total de valores, que será incrementada pelo ForEach
             */
            int sum = 0;
